...
public class AArch64HotSpotJVMCIBackendFactory implements HotSpotJVMCIBackendFactory {
    ...
    private EnumSet<AArch64.CPUFeature> computeFeatures(@SuppressWarnings("unused") AArch64HotSpotVMConfig config) {
        // Configure the feature set using the HotSpot flag settings.
        EnumSet<AArch64.CPUFeature> features = EnumSet.noneOf(AArch64.CPUFeature.class);
        return features;
    }

    private EnumSet<AArch64.Flag> computeFlags(@SuppressWarnings("unused") AArch64HotSpotVMConfig config) {
        EnumSet<AArch64.Flag> flags = EnumSet.noneOf(AArch64.Flag.class);
        return flags;
    }

    private TargetDescription createTarget(AArch64HotSpotVMConfig config) {
    ...
    private RegisterConfig createRegisterConfig(AArch64HotSpotVMConfig config, TargetDescription target) {
    ...
    private HotSpotMetaAccessProvider createMetaAccess(HotSpotJVMCIRuntimeProvider runtime) {
