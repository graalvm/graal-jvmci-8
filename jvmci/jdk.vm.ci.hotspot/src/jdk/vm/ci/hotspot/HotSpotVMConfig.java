...
class HotSpotVMConfig extends HotSpotVMConfigAccess {
    ...
    final int javaMirrorOffset = getFieldOffset("Klass::_java_mirror", Integer.class, "oop");
    ...
    final int klassMiscFlagsOffset = getFieldOffset("InstanceKlass::_misc_flags", Integer.class, "u2");
