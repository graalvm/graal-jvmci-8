...
void LIRGenerator::do_ProfileInvoke(ProfileInvoke* x) {
  ...
  if (!x->inlinee()->is_accessor()) {
    ...
    increment_event_counter_impl(info, x->inlinee(), LIR_OprFact::intConst(InvocationCounter::count_increment), right_n_bits(Tier23InlineeNotifyFreqLog), InvocationEntryBci, false, true);
  }
}
