...
#define VM_STRUCTS(nonstatic_field, \
 ...
 unchecked_nonstatic_field(GenCollectedHeap,   _gens,                                         sizeof(GenCollectedHeap::_gens)) /* NOTE: no type */ \
  ...
  nonstatic_field(JavaThread,                  _stack_overflow_limit,                         address)                               \
...
#define VM_INT_CONSTANTS(declare_constant,                                \
  ...
  /*********************************/                                     \
                                                                          \
  declare_constant(InstanceKlass::_misc_has_default_methods)              \
  declare_constant(InstanceKlass::_misc_declares_default_methods)         \
                                                                          \
  /*********************************/                                     \
